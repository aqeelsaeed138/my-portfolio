      ...
      <div className="container mx-auto max-w-7xl relative z-10 h-full flex flex-col justify-center py-16 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-300 text-base max-w-2xl mx-auto leading-relaxed">
            Full-stack software engineer proficient in C++, JavaScript, TypeScript,
            Dart, React, Next.js, Flutter, Firebase, Node.js, MongoDB, SQL, and
            cloud technologies. Experienced in building mobile and web apps,
            AI-powered tools, and real-time applications.
          </p>
